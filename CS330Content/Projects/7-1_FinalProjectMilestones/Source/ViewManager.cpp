...
GLFWwindow* ViewManager::CreateDisplayWindow(const char* windowTitle)
{
	...
	// this callback is used to receive mouse wheel scroll moving events
 ...
 *  mouse wheel is scrolled within the active GLFW display window.
 ***********************************************************/
...
void ViewManager::ProcessKeyboardEvents()
{
	...
	// switch to orthographic projection view
	if (glfwGetKey(m_pWindow, GLFW_KEY_O) == GLFW_PRESS)
	{
		bOrthographicProjection = true;
	}

	// switch to perspective projection view
...
void ViewManager::PrepareSceneView()
{
	...
	{
		// set projection matrix to orthographic front view with aspect-ratio correction
		double scale = 0.0;
	...
	{
		// define the current projection matrix as perspective
